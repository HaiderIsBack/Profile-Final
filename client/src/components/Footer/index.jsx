...
const Footer = () => {
    ...
    return (
        <footer className="container mx-auto py-10 px-3 xl:px-0">
            <div className="w-full py-24 border-[1px] border-[#444] flex flex-col justify-center items-center rounded-3xl">
                ...
                <h2 className="text-4xl xl:text-[100px] hover:text-[var(--accent-color)] cursor-pointer duration-300 email-link my-5 xl:my-10">Haidershahpak17@gmail.com</h2>
